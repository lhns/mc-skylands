...
import net.minecraft.block.material.{MapColor, Material, MaterialColor}
...
/**
  ...
  */
class BlockCloud extends Block(BlockCloud.settings) {
...
object BlockCloud {
  val MaterialCloud: Material = new Material.Builder(MaterialColor.WOOL) {
    flammable()
  }.build()

  private val settings: AbstractBlock.Properties =
    AbstractBlock.Properties
      .create(MaterialCloud)
