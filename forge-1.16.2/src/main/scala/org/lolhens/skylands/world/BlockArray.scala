...
trait BlockArray {
  ...
  def setBlockState(position: BlockPos, blockState: BlockState): Unit

  def getBlockState(position: BlockPos): BlockState = get(position, _.getBlockState(_))
...
object BlockArray {
  def apply(world: World) = new BlockArray {
    ...
    override def setBlockState(position: BlockPos, blockState: BlockState): Unit = world.setBlockState(position, blockState)
  }
  ...
  def syncVertical(bottom: World, top: World, overlap: Int) = new BlockArray {
    ...
    override def setBlockState(position: BlockPos, blockState: BlockState): Unit = {
